...
const GovernSchool = () => {
  ...
  return (
    ...
    <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 '>
              ...
              <select name="" id="" className='border border-secondary md:px-5 px-3 md:py-2 py-1'>
                <option value="">List of few government schools</option>
                <option value="">Gurgaon</option>
                <option value="">Jacobpura</option>
                <option value="">Sec-47</option>
              </select>
              <input type="text" 
                placeholder='Enter your primary school grade'
